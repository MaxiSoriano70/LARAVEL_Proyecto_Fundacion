...
<div class="row mt-5">
  <div class="d-flex justify-content-center">
      <h1 class="text-center">DETALLE DE CATEGORIA</h1>
  </div>
</div>
<div class="row mt-2">
  <div class="d-flex justify-content-center">
