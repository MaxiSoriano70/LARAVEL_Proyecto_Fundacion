@include('Libs.Header')
    ...
    <div class="container my-3">
        <div class="row">
                ...
                <a href="{{route('Categorias.create')}}" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                    width="25" height="25"
                    viewBox="0 0 172 172"
    ...
    <div class="row mt-3 align-items-center">
        <div class="col-md col-xl-4">
         ...
         <div class="col-md col-xl-4">
            <h3 class="text-center">Tabla de tus Categorias</h3>
        </div>
        <div class="col-md col-xl-4">
        </div>
    </div>
        ...
        <tbody>
            @foreach ($arrayCategoria as $dato)
                            <tr>
                                ...
                                <td>{{$dato->Nombre}}</td>
                                <td>
                                    <a href="{{route('Categorias.show', $dato->idCategoria)}}" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                        width="25" height="25"
                                        viewBox="0 0 172 172"
                                ...
                                <td>
                                    <a href="{{route('Categorias.edit', $dato->idCategoria)}}" class="btn btn-warning"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                        width="25" height="25"
                                        viewBox="0 0 172 172"
                                ...
                                <td>
                                    <form action="{{ route('Categorias.destroy', $dato->idCategoria) }}" method="POST">
                                        @method('DELETE')
                                        @csrf
