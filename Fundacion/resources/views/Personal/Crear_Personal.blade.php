...
<div class="row mt-5">
<div class="d-flex justify-content-center">
<form class="mt-3 align-items-center w-75 needs-validation" novalidate method="post" action="{{route('Personal.store');}}">
    @csrf
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input name="Dni" type="number" class="form-control" id="Dni" required>
        @if ($errors->has('Dni'))
    ...
    <div class="mb-3">
        ...
        <input name="Clave_c" type="password" class="form-control" id="exampleInputPassword1" required>
        @if ($errors->has('Clave_c'))
          <div>*La contraseñas no coinciden</div><br>
        @endif
      </div>
    <div class="mb-3">
        <label class="form-label" for="">*Tipo de Personal</label>
        <select class="form-select" name="idTipo" aria-label="Default select example">
            <option selected>Seleccionar tipo de personal</option>
    ...
    <div class="mb-3">
        ...
        <input name="Fecha_de_nacimiento" type="date" class="form-control" id="FechadeNacimiento">
      </div>
    <div class="mb-3">
    ...
    <a href="{{route('Personal.index')}}" type="button" class="btn btn-secondary mx-2"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
      width="25" height="25"
      viewBox="0 0 172 172"
