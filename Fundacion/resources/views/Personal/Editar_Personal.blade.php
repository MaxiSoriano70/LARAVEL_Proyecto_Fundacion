...
<div class="row mt-5">
<div class="d-flex justify-content-center">
@foreach ($arrayPersonal as $item)
<form class="mt-3 align-items-center w-75" method="POST" action="{{ route('Personal.update',$item->idPersonal); }}">
    @csrf
    @method('PUT')
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input name="Fecha_de_nacimiento" type="date" class="form-control" id="FechadeNacimiento" value="{{$item->Fecha_Nacimiento}}">
      </div>
    <div class="mb-3">
