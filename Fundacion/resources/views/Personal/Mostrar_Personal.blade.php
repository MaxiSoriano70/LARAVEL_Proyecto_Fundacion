...
<div class="row mt-5">
    <div class="d-flex justify-content-center">
        <h1 class="text-center">DETALLE DE PERSONAL</h1>
    </div>
</div>
<div class="row mt-2">
    <div class="d-flex justify-content-center">
    ...
    <div class="card text-center">
        ...
        <div class="card-body">
          ...
          <h5 class="card-text"><b>Dirección: </b>
            ...
            <a href="{{route('Personal.index')}}" type="button" class="btn btn-secondary my-2"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                width="25" height="25"
                viewBox="0 0 172 172"
        ...
        <div class="card-footer text-muted">
            <h4>
            @if ($item->idTipo==1)
                <b>Tipo de Usuario:</b> Administrativo
            @endif
            @if ($item->idTipo==2)
                <b>Tipo de Usuario:</b> Profesor
            @endif
            </h4>
        </div>
    </div>
