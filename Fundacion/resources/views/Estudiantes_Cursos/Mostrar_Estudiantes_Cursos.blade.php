...
<div class="row mt-5">
  <div class="d-flex justify-content-center">
      <h1 class="text-center">DETALLE ALUMNO X CURSO</h1>
  </div>
</div>
@foreach ($arrayDatos as $item)
<div class="row mt-2">
  <div class="d-flex justify-content-center">
    <h3 class="text-center"><b>Alumno: {{$item->Nombre}} {{$item->Apellido}}</b></h3>
  </div>
</div>
