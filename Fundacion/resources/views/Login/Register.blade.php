...
<div class="row mt-5">
  <div class="d-flex justify-content-center">
    <form class="mt-3 w-50 needs-validation" novalidate method="post" action="{{route('Login.store');}}">
    @csrf
    <div class="mb-3">
    ...
    <a href="{{route('Login.index')}}" type="button" class="btn btn-secondary mx-2"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
        width="25" height="25"
        viewBox="0 0 172 172"
