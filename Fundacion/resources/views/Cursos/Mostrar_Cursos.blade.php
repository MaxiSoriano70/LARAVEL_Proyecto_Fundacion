...
<div class="row mt-5">
  <div class="d-flex justify-content-center">
      <h1 class="text-center">DETALLE DE CURSO</h1>
  </div>
</div>
<!--<div class="row mt-2">
  <div class="d-flex justify-content-center">
    ...
    <div class="row g-0">
      ...
      <div class="col-md-8">
        <div class="card-body">
          ...
          <h4 class="card-title"><b>Categoria:</b> {{$item->Categoria}}</h4>
          <h5 class="card-text">{{$item->Descripcion}}</h5>
        </div>
        <div class="card-footer text-muted">
                <a class="btn btn-warning my-2 mx-2" href="{{ route('Cursos.edit',$item->idCurso); }}"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                    width="25" height="25"
                    viewBox="0 0 172 172"
                ...
                <a href="{{route('Cursos.index')}}" type="button" class="btn btn-secondary my-2 mx-2"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                    width="25" height="25"
                    viewBox="0 0 172 172"
