@include('Libs.Header')
    ...
    <div class="container my-3">
        <div class="row">
                ...
                <a href="{{route('Cursos.create')}}" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                    width="25" height="25"
                    viewBox="0 0 172 172"
    ...
    <div class="row mt-3 align-items-center">
        <div class="col-md col-xl-4">
         ...
         <div class="col-md col-xl-4">
            <h3 class="text-center">Tabla de tus Cursos</h3>
        </div>
        <div class="col-md col-xl-4">
        </div>
    </div>
    <table id="example" class="table table-striped" style="width:100%">
        ...
        <tbody>
            @foreach ($arrayCurso as $dato)
                            <tr>
                                <td>{{$dato->idCurso}}</td>
                                <td>{{$dato->Nombre}}</td>
                                <td>{{$dato->Categoria}}</td>
                                <td>
                                    <a href="{{route('Cursos.show', $dato->idCurso)}}" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                        width="25" height="25"
                                        viewBox="0 0 172 172"
                                ...
                                <td>
                                    <a href="{{route('Cursos.edit', $dato->idCurso)}}" class="btn btn-warning"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                        width="25" height="25"
                                        viewBox="0 0 172 172"
                                ...
                                <td>
                                    <form action="{{ route('Cursos.destroy', $dato->idCurso) }}" method="POST">
                                        @method('DELETE')
                                        @csrf
