...
<div class="row mt-5">
  <div class="d-flex justify-content-center">
      <h1 class="text-center">DETALLE PROFESOR X CURSO</h1>
  </div>
</div>
@foreach ($arrayPersonal_Cursos as $item)
<div class="row mt-2">
  <div class="d-flex justify-content-center">
    <h3 class="text-center"><b>Prof. {{$item->Nombre}} {{$item->Apellido}}</b></h3>
  </div>
</div>
    <div class="card text-center">
        <div class="card-header">
          <h4><b>"Curso: {{$item->Curso}}"</b></h4>
        </div>
        <div class="card-body">
          <h5 class="card-text"><b>Dni Prof: </b>{{$item->Dni}}<h5>
          ...
          <h5 class="card-text"><b>Comisión: </b>
            @if ($item->Comision=="")
                "No definido"
                @else
                {{$item->Comision}}
            @endif</h5>
         <h5 class="card-text"><b>Duración: </b>
            @if ($item->Duracion=="")
                "No definido"
            @else
                {{$item->Duracion}}
