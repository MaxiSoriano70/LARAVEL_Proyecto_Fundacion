@include('Libs.Header')
    <div class="container my-3">
        <h1 class="text-center">Tipos de Cursos</h1>
    </div>
    <div class="container my-3">
        <div class="row">
                <div class="col text-center">
                <a href="{{route('TiposCursos.create')}}" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                    width="25" height="25"
                    viewBox="0 0 172 172"
    ...
    <div class="row mt-3 align-items-center">
        <div class="col-md col-xl-4">
         ...
         <div class="col-md col-xl-4">
            <h3 class="text-center">Tabla de tus Tipos de Cursos</h3>
        </div>
        <div class="col-md col-xl-4">
        </div>
    </div>
    <table id="example" class="table table-striped" style="width:100%">
        ...
        <tbody>
            @foreach ($arrayTiposCursos as $dato)
                            <tr>
                                <td>{{$dato->idTipo_Curso}}</td>
                                <td>{{$dato->Nombre}}</td>
                                <td>
                                    <a href="{{route('TiposCursos.edit', $dato->idTipo_Curso)}}" class="btn btn-warning"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                        width="25" height="25"
                                        viewBox="0 0 172 172"
                                ...
                                <td>
                                    <form action="{{ route('TiposCursos.destroy', $dato->idTipo_Curso) }}" method="POST">
                                        @method('DELETE')
                                        @csrf
