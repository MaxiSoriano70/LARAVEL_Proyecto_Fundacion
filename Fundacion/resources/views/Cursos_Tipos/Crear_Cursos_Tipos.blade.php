...
<div class="row mt-5">
    <div class="d-flex justify-content-center">
        <h1>ALTA DE CURSOS X TIPOS</h1>
    </div>
</div>
<div class="row mt-5">
<div class="d-flex justify-content-center">
<form class="mt-3 w-75 needs-validation" novalidate method="post" action="{{route('Cursos_Tipos.store');}}">
    @csrf
    <div class="mb-3">
        <label class="form-label" for="">*Curso</label>
        <select class="form-select" name="Curso" aria-label="Default select example" required>
        <option selected>Seleccionar un curso</option>
    ...
    <div class="mb-3">
        ...
        <option selected>Seleccionar la Modalidad</option>
          @foreach ($arrayTiposCursos as $item)
            <option value="{{$item->idTipo_Curso}}">{{$item->Nombre}}</option>
          @endforeach
        </select>
    ...
    <div class="mb-3">
        ...
        <input name="Vacantes" type="text" class="form-control" id="Vacantes" required>
    ...
    <div class="mb-3">
        ...
        <input name="Fecha_de_Inicio" type="date" class="form-control" id="FechadeInicio">
    </div>
    <div class="mb-3">
        <label class="form-label">Fecha de Fin</label>
        <input name="Fecha_de_Fin" type="date" class="form-control" id="FechadeFin">
    </div>
    <div class="mb-3">
        <label class="form-label" for="Turno">Turno</label>
        <input name="Turno" type="text" class="form-control" id="Turno">
    </div>
    <div class="mb-3">
