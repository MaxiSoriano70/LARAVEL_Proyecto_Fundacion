...
<footer class="footer text-center bg-color4 color4 py-5 mt-3">
    <div class="container">
        <div class="row">
            <!-- Footer Location-->
            ...
            <div class="col-lg-4 mb-5 mb-lg-0">
                ...
                <a class="btn btn-outline-dark btn-social mx-1" href="#!" style="Border:none;"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                    width="25" height="25"
                    viewBox="0 0 172 172"
                    style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M86,16.125c-38.58712,0 -69.875,31.28788 -69.875,69.875c0,35.03156 25.80806,63.95981 59.42869,69.01231v-50.49544h-17.28869v-18.36638h17.28869v-12.22275c0,-20.23419 9.85775,-29.11369 26.67613,-29.11369c8.05175,0 12.31681,0.59931 14.32975,0.86806v16.03094h-11.47025c-7.138,0 -9.632,6.7725 -9.632,14.39963v10.03781h20.92219l-2.83531,18.36638h-18.08687v50.64056c34.10437,-4.6225 60.41769,-33.78188 60.41769,-69.15744c0,-38.58712 -31.28519,-69.875 -69.875,-69.875z"></path></g></g></svg></a>
                <a class="btn btn-outline-dark btn-social mx-1" href="#!" style="Border:none;"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                    width="25" height="25"
                    viewBox="0 0 172 172"
...
<!-- Copyright Section-->
<div class="copyright py-4 text-center bg-color3 color3">
    <div class="container"><small>Copyright &copy; INI Computación 2021</small></div>
</div>
@include('Libs.Foot')
